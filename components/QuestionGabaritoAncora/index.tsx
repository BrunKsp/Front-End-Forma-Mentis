...
const QuestionGabaritoAncora: FC<IProps> = ({
  question,
  contador,
  numbers,
}) => {
            ...
            return (
              <>
                {alter.respostaSelecionada && alter.respostaCorreta ? (
                  ...
                  <>
                    {alter.respostaSelecionada === false ? (
                      <MainAlter>
                        <Button
                      ...
                      <MainAlter>
                        <Button
                          color={alter.respostaSelecionada ? "#09772E" : "#555"}
                        ></Button>
                        <TextAlter
                          color={alter.respostaSelecionada ? "#09772E" : "#000"}
                        >
                          {alter.pergunta}
                        </TextAlter>
                      </MainAlter>
...
export default QuestionGabaritoAncora;
