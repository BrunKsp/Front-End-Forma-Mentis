...
import { getResultado } from "services/Questions";
            ...
            {router.isFallback === true ? (
              ...
              <div style={{ width: "100%" }}>
                ...
                >
                  ...
                  <ResultCard infos={resultado} calcPorcent={calcPorcent} />
                </div>
                <DivButtons>
                  <ReactToPrint
                  ...
                  <Link
                    ...
                    href={`/formulario/resultado/gabarito/${hash}`}
                    passHref
                  >
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  try {
    const { data } = await getResultado(hash);
    return {
      props: {
        hash,
        resultado: data,
